...
<head>
    <?php $pageTitle = "Bolakaz | Cookie Policy"; include "head.php"; ?>
</head>
...
<body>
    ...
    <div class="container-fluid bg-secondary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 300px">
            <h1 class="font-weight-semi-bold text-uppercase mb-3">Cookie Policy</h1>
            <div class="d-inline-flex">
                <p class="m-0"><a href="index">Home</a></p>
                <p class="m-0 px-2">-</p>
                <p class="m-0">Cookie Policy</p>
            </div>
        </div>
    </div>
    <!-- Page Header End -->
            ...
            <li>
                <p>
                    ...
                    <a
                        ...
                        class="__cf_email__"
                        data-cfemail="d2bbbcb4bd92a7bcbbb0bdbdb9a1fcb1bdbffcbcb5">[email&#160;protected]</a>
                </p>
            </li>
            <li>
                <p>
