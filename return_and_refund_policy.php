...
<head>
    <?php $pageTitle = "Bolakaz | Return and Refund Policy"; include "head.php"; ?>
</head>
...
<body>
    ...
    <div class="container-fluid bg-secondary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 300px">
            <h1 class="font-weight-semi-bold text-uppercase mb-3">Return & Refund Policy</h1>
    ...
    <div class="container-fluid pt-5">
        ...
        <p>Thank you for shopping at Bolakaz Enterprise .</p>
        <p>
            ...
            <a
                ...
                target="_blank">Return and Refund Policy Generator</a>.
        </p>
        <p>
            ...
            <li>
                <p>
                    ...
                    <a
                        ...
                        class="__cf_email__"
                        data-cfemail="71181f171e31041f18131e1e1a025f121e1c5f1f16">[email&#160;protected]</a>
                </p>
            </li>
            <li>
                <p>
        ...
        <p>
            Dogo daji street, beside bentex guest house, katampe, kubwa village, abuja
        </p>
        <p>
            ...
            <li>
                <p>
                    ...
                    <a
                        href="/cdn-cgi/l/email-protection"
                        class="__cf_email__"
                        data-cfemail="660f0800092613080f0409090d154805090b480801">[email&#160;protected]</a>
                </p>
            </li>
            <li>
                <p>
