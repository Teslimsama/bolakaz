...
<body>
    ...
    <div class="container-fluid bg-secondary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 300px">
            <h1 class="font-weight-semi-bold text-uppercase mb-3">Disclaimer</h1>
    ...
    <div class="container-fluid pt-5">
        ...
        <ul>
            <li>
                ...
                &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Disclaimer) refers
                to Bolakaz Enterprise , Dogo daji street,beside bentex guest house ,katampe
                , kubwa village,abuja.
            </li>
        ...
        <p>The information provided on this website is for general informational purposes only. All content, including text, graphics, images, and information, is provided on an "as is" basis, without warranty of any kind, either express or implied. We do not warrant that the information is accurate, reliable, complete, or current.</p>

        <p>Your use of the website is at your own risk. We are not liable for any errors or omissions in the content or for any actions taken based on the information provided on this site. We make no guarantees that the website will be available at all times, free of errors, or free of viruses or other harmful components.</p>

        <h3>Ads Disclaimer</h3>
        <p>We show ads on our website, including but not limited to Google Ads. These ads may be based on your browsing history and preferences. We do not endorse the products, services, or content featured in these ads. The appearance of any advertisement on the website does not constitute an endorsement by us. Any dealings you have with advertisers found on our website are solely between you and the advertiser, and we are not responsible for any loss or damage that may arise from such dealings.</p>

        <p>By using our website, you acknowledge and agree that we are not responsible for the availability of external sites or resources, and do not endorse or are responsible for any content, advertising, products, or other materials on or available from such sites or resources.</p>
        <p>
        ...
        <p>
            ...
            <a href="https://www.termsfeed.com/disclaimer-generator/" target="_blank">Disclaimer Generator</a>.
        </p>
        <p>
            ...
            <li>
                <p>
                    ...
                    <a
                        ...
                        class="__cf_email__"
                        data-cfemail="2d44434b426d5843444f4242465e034e424003434a">[email&#160;protected]</a>
                </p>
            </li>
            <li>
                <p>
