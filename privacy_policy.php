...
<head>
    <?php $pageTitle = "Bolakaz | Privacy Policy"; include "head.php"; ?>
</head>
...
<body>
    ...
    <div class="container-fluid pt-5">
        ...
        <ul>
            ...
            <li>
                <p>
                    ...
                    refers to Bolakaz Enterprise , Dogo daji street,beside bentex guest house
                    , katampe, kubwa village, abuja.
                </p>
            </li>
            <li>
                <p>
            ...
            <li>
                <p>
                    <strong>Website</strong> refers to Bolakaz Enterprise , accessible from
                    <a
                        href="https://bolakaz.unibooks.com.ng"
                        rel="external nofollow noopener"
                        target="_blank">https://bolakaz.unibooks.com.ng</a>
                </p>
            </li>
            <li>
                <p>
        ...
        <h3>Tracking and Analytics Tools</h3>
        <p>
            We use tracking and analytics tools, such as Google Analytics, to understand
            how visitors interact with our website. These tools help us improve our
            services and provide you with a better user experience. Google Analytics
            collects data such as your IP address, browser type, and pages visited. You
            can opt out of Google Analytics by installing a browser add-on available at
            <a href="https://tools.google.com/dlpage/gaoptout">this link</a>.
        </p>

        <h3>Email Communications</h3>
        <p>
            We send emails to users for various purposes, including updates, promotions,
            and newsletters. You can opt-in to receive these emails, and you may
            unsubscribe at any time by following the instructions in the email or by
            contacting us directly.
        </p>

        <h3>Advertising</h3>
        <p>
            We show ads on our website through various advertising platforms, such as
            Google Ads. These ads may be tailored to your interests based on your browsing
            behavior. You can opt out of personalized advertising through your browser
            settings or by visiting the advertising platform's opt-out page.
        </p>

        <h3>Payments</h3>
        <p>
            Users can pay for our products and services through secure payment processors
            like PayPal. We do not store your full payment details; they are handled
            securely by the payment processor. Please review their privacy policies for
            more information.
        </p>

        <h3>Remarketing Services</h3>
        <p>
            We use remarketing services to advertise our business across the web. These
            services may use cookies and other tracking technologies to show you ads based
            on your previous visits to our website. You can opt out of remarketing by
            adjusting your cookie preferences or by visiting the remarketing service's
            opt-out page.
        </p>

        <h3>Invisible reCAPTCHA</h3>
        <p>
            We use Google's Invisible reCAPTCHA to protect our website from spam and
            abuse. This tool collects information about users to distinguish between
            humans and bots. The use of Invisible reCAPTCHA is subject to Google's Privacy
            Policy and Terms of Service.
        </p>

        <h3>Google Places</h3>
        <p>
            We integrate Google Places to provide location-based services on our website.
            This integration may collect information such as your location, search
            queries, and device data. By using our services, you agree to Google's Privacy
            Policy.
        </p>

        <h3>Mouseflow</h3>
        <p>
            We use Mouseflow to track user interactions on our website. This tool helps us
            understand how users navigate our site, allowing us to improve usability.
            Mouseflow may collect data such as mouse movements, clicks, and form inputs.
            You can opt out of Mouseflow tracking by visiting
            <a href="https://mouseflow.com/opt-out/">this link</a>.
        </p>

        <h3>FreshDesk</h3>
        <p>
            We use FreshDesk for customer support and service management. FreshDesk may
            collect data such as your name, email address, and support inquiries. This
            data is used to provide and improve our customer support services.
        </p>

        <h3>CCPA + CPRA Compliance</h3>
        <p>
            ...
            specific rights regarding your personal information. These include the right
            to know what personal information we collect, the right to request deletion of
            your personal information, the right to opt out of the sale of your personal
        ...
        <p>
            ...
            Regulation (GDPR). You have the right to access your personal data, the right
            to rectify inaccuracies, the right to erasure, the right to restrict
            processing, the right to data portability, and the right to object to
            processing. You can exercise these rights by contacting us.
        </p>

        <h3>CalOPPA Compliance</h3>
        <p>
            We comply with the California Online Privacy Protection Act (CalOPPA). We
            honor Do Not Track signals and do not track, plant cookies, or use advertising
            when a Do Not Track (DNT) browser mechanism is in place. We also disclose any
            data collection practices and the types of personal information collected.
        </p>

        <h3>Children's Privacy (COPPA Compliance)</h3>
        <p>
            We comply with the Children's Online Privacy Protection Act (COPPA). If we
            collect personal information from children under the age of 13, we do so with
            ...
            <li>
                <p>
                    ...
                    <a
                        ...
                        class="__cf_email__"
                        data-cfemail="30595e565f70455e59525f5f5b431e535f5d1e5e57">[email&#160;protected]</a>
                </p>
            </li>
            <li>
                <p>
                    ...
                    <a
                        href="https://bolakaz.unibooks.com.ng/contact"
                        rel="external nofollow noopener"
                        target="_blank">https://bolakaz.unibooks.com.ng/contact</a>
                </p>
            </li>
            <li>
                <p>By phone number: 08077747898</p>
            </li>
        </ul>
        <script
            data-cfasync="false"
